...
echo "<script>alert('Absen Masuk berhasil disimpan!');document.location='../index.php'</script>";
}
...
echo "<script>alert('Absen pulang berhasil disimpan!');document.location='../index.php'</script>";
}
...
echo "<script>alert('Absen Masuk berhasil dirubah!');document.location='../index.php'</script>";
}
 ?>