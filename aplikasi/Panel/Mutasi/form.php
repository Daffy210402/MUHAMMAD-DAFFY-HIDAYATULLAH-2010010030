...
<?php 
if ($_GET['form'] == "Ubah") {
	$sql    = mysqli_query($koneksi,"SELECT * FROM mutasi WHERE id_mutasi='$id'");
							...
							<?php if ($akses == "Pegawai"): ?>
								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" type="text"  name="tgl_mutasi"  value="<?=date("m/d/Y", strtotime($data['tgl_mutasi']));?>" required>
									</div>
								</div>
								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<input id="keterangan_mutasi" class="form-control" type="text" name="keterangan_mutasi" value="<?=$data['keterangan_mutasi'];?>" required>
									</div>
								</div>
