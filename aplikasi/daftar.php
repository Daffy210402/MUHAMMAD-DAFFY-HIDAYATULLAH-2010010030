...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 register-card bg-opacity-8">
    <?php include 'conf/daftar.php'; ?>
    <form class="login-form" method="POST">
      <div class="row">
        <div class="input-field col s12">
          <h5 class="ml-4">Daftar</h5>
        </div>
      </div>
      <div class="row margin">
        <div class="input-field col s12">
          ...
          <label for="instansi" class="center-align">Nama Instansi</label>
        </div>
      </div>
      <div class="row margin">
        <div class="input-field col s12">
          ...
          <label for="nama_pengguna" class="center-align">Nama Pengguna</label>
        </div>
      </div>
      <div class="row margin">
        <div class="input-field col s12">
          ...
          <label for="telp" class="center-align">Kontak/Telepon</label>
        </div>
      </div>
      <div class="row margin">
        <div class="input-field col s12">
      ...
      <div class="row">
        <div class="input-field col s12">
          <button name="daftar" class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12">Daftar</button>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
          <p class="margin medium-small"><center>Sudah Memiliki Akun? <a href="index.php">Masuk Disini</a></center></p>
        </div>
      </div>
    </form>
  </div>
